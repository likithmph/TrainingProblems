 ...
 */
@Generated
public class SpringBootRestJpa1Application__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SpringBootRestJpa1Application__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SpringBootRestJpa1Application__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
